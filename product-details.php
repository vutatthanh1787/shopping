...
if(isset($_GET['action']) && $_GET['action'] == "add"){
	...
	if(isset($_SESSION['cart'][$id])){
		...
		if(mysqli_num_rows($query_p) != 0){
			...
			print_r($_SESSION['cart'][$row_p['id']]);
			//die('111');
...
if(isset($_GET['pid']) && $_GET['action'] == "wishlist" ){
	...
	{
		$conn->query("insert into wishlist(userId,productId) values('".$_SESSION['id']."','$pid')");
...
if(isset($_POST['submit']))
{
	...
	$review  = $_POST['review'];
	$conn->query("insert into productreviews(productId,quality,price,value,name,summary,review) values('$pid','$qty','$price','$value','$name','$summary','$review')");
}
	...
	<div class="breadcrumb">
		<div class="container">
			<div class="breadcrumb-inner">
				<?php
				$ret = $conn->query("select category.categoryName as catname,subCategory.subcategory as subcatname,products.productName as pname from products join category on category.id=products.category join subcategory on subcategory.id=products.subCategory where products.id='$pid'");
				while ($rw = $ret->fetch_assoc()) {
					?>
				...
				<div class='row single-product outer-bottom-sm '>
					<div class='col-md-3 sidebar'>
						<div class="sidebar-module-container">
							...
							<div class="sidebar-widget outer-bottom-xs wow fadeInUp">
								...
								<div class="sidebar-widget-body m-t-10">
									<div class="accordion">
										...
										<?php 
										$sql = $conn->query("select id, categoryName  from category");
								...
								<div class="sidebar-widget hot-deals wow fadeInUp">
									...
									<div class="owl-carousel sidebar-carousel custom-carousel owl-theme outer-top-xs">
										...
										<?php
										$ret = $conn->query("select * from products order by rand() limit 4 ");
										while ($rws = $ret->fetch_assoc()) {
											?>
											<div class="item">
												<div class="products">
							...
							<?php 
								$ret = $conn->query("select * from products where id='$pid'");
									...
									<div class="row  wow fadeInUp">
										...
										<div class='col-sm-6 col-md-7 product-info-block'>
											<div class="product-info">
												...
												<?php 
													$rt = $conn->query("select * from productreviews where productId='$pid'");
										...
										<div class="row">
													...
													<div id="review" class="tab-pane">
														<div class="product-tab">
															...
															<div class="product-reviews">
																...
																<?php 
																$qry = $conn->query("select * from productreviews where productId='$pid'");
																while($rvw = $qry->fetch_assoc())
																{
																	?>
											...
											<section class="section featured-product wow fadeInUp">
												...
												<div class="owl-carousel home-owl-carousel upsell-product custom-carousel owl-theme outer-top-xs">
													...
													<?php 
													$qry = $conn->query("select * from products where subCategory='$subcid' and category='$cid'");
													while($rw = $qry->fetch_assoc()){
													?>	
