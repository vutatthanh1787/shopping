								...
								<form name="cart" method="post">	
									...
									<table class="table table-bordered">
										...
										<tbody>
											...
											<?php 
												$query = $conn->query("select products.productImage1 as pimg1,products.productName as pname,orders.productId as opid,orders.quantity as qty,products.productPrice as pprice,products.shippingCharge as shippingcharge,orders.paymentMethod as paym,orders.orderDate as odate,orders.id as orderid from orders join products on orders.productId=products.id where orders.userId='".$_SESSION['id']."' and orders.paymentMethod is not null");
												$cnt = 1;
											while($row = $query->fetch_assoc())
											{
												...
												<tr>
													...
													<td class="cart-product-name-info">
														...
														<td>
															<a href="javascript:void(0);" onClick="popUpWindow('http://localhost/websites/ShoppingPortalProVersion/shopping/track-order.php?oid=<?php echo htmlentities($row['orderid']);?>');" title="Track order">
															Track</td>
														</tr>
														<?php $cnt=$cnt+1;} ?>
