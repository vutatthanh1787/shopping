...
if(isset($_POST['ordersubmit'])) 
{
	...
	{   
		...
		foreach($value as $qty=> $val34){
			$conn->query("insert into orders(userId,productId,quantity) values('".$_SESSION['id']."','$qty','$val34')");
														...
														<tr>
															...
															<td class="cart-product-name-info">
																...
																<div class="row">
																	...
																	<div class="col-sm-8">
																		<?php 
																			$rt = $conn->query("select * from productreviews where productId='$pd'");
														...
														<tr>
															<td>
																<div class="form-group">
																	<?php 
																		$qry = $conn->query("select * from users where id='".$_SESSION['id']."'");
																		while ($rt = $qry->fetch_assoc()) {
