...
{	
	...
	if(isset($_POST['submit']))
	{
		...
		$query = $conn->query("insert into subcategory(categoryid,subcategory) values('$category','$subcat')");
		$_SESSION['msg'] = "SubCategory Created !!";
	}

	if(isset($_GET['del']))
	{
		$conn->query("delete from subcategory where id = '".$_GET['id']."'");
											...
											<div class="module">
												...
												<div class="module-body table">
													<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
														...
														<tbody>
															<?php 
																$query = $conn->query("select subcategory.id,category.categoryName,subcategory.subcategory,subcategory.creationDate,subcategory.updationDate from subcategory join category on category.id=subcategory.categoryid");
																$cnt = 1;
																while($row = $query->fetch_assoc()) :
															?>									
																<tr>
