...
if(isset($_GET['pid']) && $_GET['action'] == "wishlist" ){
	...
	{
		$conn->query("insert into wishlist(userId,productId) values('".$_SESSION['id']."','".$_GET['pid']."')");
							...
							<nav class="yamm megamenu-horizontal" role="navigation">
								...
								<ul class="nav">
									<li class="dropdown menu-item">
										<?php 
										$sql = $conn->query("select id,subcategory  from subcategory where categoryid='$cid'");
							...
							<div class="item">	
								...
								<div class="container-fluid">
									<div class="caption vertical-top text-left">
										...
										<?php 
										$sql = $conn->query("select categoryName  from category where id='$cid'");
										while($row = $sql->fetch_assoc()) :
											?>
							...
							<div id="myTabContent" class="tab-content">
								<div class="tab-pane active " id="grid-container">
									<div class="category-product  inner-top-vs">
										<div class="row">									
											<?php
											$ret = $conn->query("select * from products where category='$cid'");
